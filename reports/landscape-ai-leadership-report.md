...
**补充：** 据越南团队同事反馈，**越南近期新项目在公司整体新项目中占比较高**，且多数处于**概念（2TA）阶段**——这与内地项目阶段分布存在差异，下文 **3.9 节** 单独记录越南一线视角。
...
> **术语对齐（沟通中曾混淆，已与越南同事确认）：** 本文 **Concept = 2TA（概念）**；**CD = 方案设计**（非 Construction Design）；**DD = 扩初/深化**；**WD = 施工图**。越南团队内部亦使用 PCD / FCD 等子阶段称呼，含义上对应概念向方案递进的「由宽到细」过程（见 **3.9 节**）。
...
### 3.9 越南团队沟通反馈（2026年7月9日，与 Tung 同事）

> 本节为本人与**越南团队**同事就项目流程、AI 使用现状及难点的企业微信沟通记录，我借助 AI 做了结构化整理。**不代表越南团队最终口径或公司政策**；与 **3.8 节（内地）** 对照阅读，可见不同区域项目结构与客户预期下的差异。

#### （一）项目结构与阶段认识

| 话题 | Tung 同事反馈要点 |
|------|-------------------|
| 新项目分布 | 越南在公司**新项目中占比较高**，多数处于**概念阶段** |
| 概念阶段典型交付 | 主要为 **PDF、SU**，有时含 **CAD** |
| 阶段递进逻辑 | 全过程类似 **「由宽到细 zoom-in」**：2TA/PCD 偏整体氛围与感觉 → FCD 聚焦客户关注的关键分区 → DD 典型详图 → WD 须落实到现场每一细节 |
| 概念通过后 | 客户常要求提交 **CAD、SU 等全套文件**，供团队更仔细研读，为后续深化打底 |

#### （二）越南团队当前 AI 使用的三大挑战

| 序号 | 挑战 | 反馈要点 |
|------|------|----------|
| 1 | **放大 / 出图清晰度** | 团队**较依赖 Airi 平台的 upscale 能力**；截至目前**未见明显更好的替代**；越南本地亦有 AI 产品在开发，但效果仍不及 |
| 2 | **纪要（MOM）提取** | **ChatGPT 使用频率高**，但在**会议记录整理与提取**上体验不足；团队倾向**另选专用 AI** 承担纪要类工作 |
| 3 | **对话「记忆」压缩** | 约一个月前尚可在单会话中输入大量图文信息且细节保留较完整；近期模型倾向**压缩上下文**（图像、研究资料等被高度概括），**难以再当作贯穿全项目的强 Agent** 使用——Tung 同事认为，这对**全流程记忆型辅助**影响较大 |

#### （三）概念阶段（2TA）：SU 极简 + AI「包装」——但总图仍是痛点

| 环节 | 做法与耗时（同事口述，大型复杂项目为例） |
|------|------------------------------------------|
| SU 模型 | 概念阶段**刻意做极简草稿模型**，再用 AI 生成透视、剖面、轴测等表达——**不单用于效果图** |
| 总图 / 彩平 | **仍是明显痛点**：通常需设计师或平面同事介入；自方案手绘草图起，**约 1 人天**整理 CAD 总图 → **再约 1 人天**由 AI 辅助生成彩平 → 成果多为 **AI + 手工 Photoshop 混合** |
| 路径瓶颈 | **目前尚无更短路径**；纯 AI 生成的总图/彩平**多数达不到团队预期** |
| 管理导向 | 遵循 Philip 指示：**概念阶段 CAD 总图保持简洁干净**，再交 AI 做图形表达 |

#### （四）客户预期决定 SU 精度与 AI 用量（概念至方案 CD）

Tung 同事强调：**AI 与手工的平衡取决于客户要什么**，设计师须自行判断「SU 做到哪里停、何时转 AI」：

| 客户类型（概括） | 团队做法 |
|------------------|----------|
| 重细节、重尺度 | 须在 SU 中做到较细（同事举例可到 **100mm 级**关注），再导出平面 → AI 辅助水彩风彩平等 |
| 重视觉冲击 | 概念阶段更多用 AI，SU 略增细节即可；**部分客户概念阶段甚至不需渲染/AI 即可过会** |
| 设计师能力差异 | AI 能力强的设计师可用**极草稿 SU** 做出较准的效果；反之则须在 SU 投入更多——**因人而异** |

**CD（方案）阶段（已与术语对齐后确认）：**

- 对客以 **PDF** 为主，同时须向其他顾问提供 **CAD** 协调；  
- **SU 仍重要**——与建筑、周边环境交织，透视等表达离不开 SU；  
- CAD 平面来源：**精细 SU 导出**，或 **SU 很粗时直接从平面起稿**，视客户要求而定；  
- 若客户要 3D 细节更多，则深化 SU → 导出 CAD → 再 AI 彩平；若客户偏「感觉」，则 SU 保持粗糙、以平面 CAD 为主；  
- **CD 阶段不必把 SU 精磨到极致**——客户要求高时，可**转入 CAD 精修精度**以满足要求。

#### （五）DD / WD 阶段：AI 目前仅能辅助，不能替代精修

| 阶段 | AI 能做什么 | 目前不能做什么 |
|------|------------|----------------|
| **CD 及以后** | 辅助**读图检查、VE（价值工程）建议**等——可「吃掉」整套资料后列出待澄清问题 | **尚不能**直接产出可用的 CAD 施工图 |
| **WD** | — | 施工图须**准确尺寸与空间关系**；若 CD/DD 模型与 CAD 精度不足，**必然影响 WD** |

Tung 与同事共识：**文件不仅是给客户看，也是团队内部研读之用**；因此无论客户要求高低，**CD、DD 仍须保证足够标准**，否则 WD 落地困难——这与本文 **L1/L2/L3 分级交付** 思路一致。

**与 Philip 方向一致的判断（Tung 转述）：**

> **越靠前阶段，AI 参与越多；越往后阶段，AI 在渲染表达上越少，更多依靠 CAD 与 SU 手工精修。** AI 目前是**助手**，**不能**替团队精修模型与 CAD。

#### （六）最难之处：旧流程惯性 vs 持续试探 AI 边界

Tung 同事认为，当前**最难的不是单一技术点**，而是：

1. **日常与「旧工具、旧做法」的拉锯**——须持续探索、更新 AI 融入设计流程的方式；  
2. **阻力更多来自团队内部习惯**（非指某一外部团队）：客户要又好又准时，若立刻按老办法让 3D 艺术家全建模，耗时长；新做法是**先测 AI 能做到的精度上限**，不行再回补 SU 细节——**来回试探本身耗时**，有时反而比直接建模更慢；  
3. 这一过程主要集中在 **2TA → FCD**；  
4. 同时团队也在**主动把 AI 往后期推**，试探后期能否多用 AI——在**质量要求与效率**之间反复平衡，**尚未找到稳定最优解**。

本人理解：这与内地同事反馈的「AI 误用、审核不清」、以及 **3.8 节** 的「跨境协同」问题**不同维度**——越南侧更突出 **AI 试错成本** 与 **工具能力边界（含记忆、总图、MOM）**。

#### （七）小结（我整理）

| 维度 | 要点 |
|------|------|
| **与内地差异** | 越南新项目多、概念占比高；修改压力更多来自**流程试错与工具边界**，而非 3.8 节所述内地报规/多层级审批机制 |
| **可复用经验** | 概念 SU 极简 + AI 包装、按客户档位灵活平衡、后期 AI 偏检查而非出图——**与全公司阶段边界判断一致** |
| **待 IT 关注** | Airi upscale 依赖、ChatGPT 纪要短板、模型上下文压缩导致「项目级 Agent」难用；总图/彩平仍缺短路径 |
| **对管理含义** | 不宜仅用「AI 用得多不多」评价越南团队——其处于**高频试错期**；日报宜记录 AI 试错场景与结论，沉淀为公司方法库 |
...
- **越南团队**新项目占比高、概念阶段 AI 使用深入，但面临 upscale 依赖、总图瓶颈、AI 记忆压缩与**旧流程 vs 新流程试错成本**等问题（详见 **3.9 节**）。
...
### 难点 1.9：越南概念团队——总图路径与 AI 工具边界（见 3.9 节）

| 现象 | 判断 |
|------|------|
| 总图 / 彩平仍须 1+1 人天量级 | **纯 AI 短路径尚未跑通**；成果依赖 AI + Photoshop 混合 |
| 依赖 Airi upscale | 替换方案不足，与内地同事反馈的「模型选择」问题**同属工具链风险** |
| ChatGPT 用于纪要不足 | 需**分工**：对话辅助 vs 纪要专用工具 |
| 模型上下文被压缩 | 难以做**全项目周期**的强 Agent，IT 须跟踪多模型长上下文能力 |
| 2TA→FCD 反复试探 AI 与 SU 分工 | **效率波动**：有时慢于直接建模——属转型期正常成本，宜记录而非简单问责 |
...
五、AI 使用（可选，建议逐步填写）
  ...
  - 若纪要/MOM：是否使用**专用工具**（越南团队反馈 ChatGPT 提取不足）
  - 是否有用 / 待核对项：
```
...
> 本人作为 IT 负责人，协助公司推进景观业务 AI 提效，在近期**内地、越南等多地同事**沟通基础上完成本梳理。**我此前将差异较多理解为「推广热度不均」，这一认识是片面的。** 实际差异主要来自项目阶段不同、工序特点不同、**区域项目结构不同**（如越南新概念项目占比高），以及**内地与海外客户预期不同**——后者直接决定各阶段成果该做到什么精度，须立项时显性化管理。
>
> **我完全认同领导层判断：** AI 是个人能力的扩展，并不能完全替代人力；对设计行业而言，人的专业能力与审美恰恰是价值所在。同时，深入拥抱 AI 是时代方向，公司应主动投入。
>
> 内地高端住宅景观项目中，**反复修改与工时偏高有相当大部分来自行业机制、报规节奏、市政变动等外部客观因素**（详见 3.8 节）；另有部分与跨境分布式协同有关，可作为内部优化方向。越南团队则处于**概念阶段 AI 深度试用期**，总图路径、工具记忆与 upscale 依赖等问题突出（详见 3.9 节）。项目负责人应在日报中区分修改来源与 AI 试错记录，**不要把行业性高频变更或转型期试错误判为内部低效或人力闲置**。个别项目亦存在客户非正常拖延，须单独标注。
>
